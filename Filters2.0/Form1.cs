namespace Filters2._0
{
    public partial class Form1 : Form
    {
        ...
        {
            // ñîçäàåì äèàëîã äëÿ îòêğûòèÿ ôàéëà
            OpenFileDialog dialog = new OpenFileDialog();
            dialog.Filter = "Image files|*.bmp;*.jpg;*.jpeg;*.png;*.gif|All files|*.*";
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                // çàãğóæàåì èçîáğàæåíèå â Bitmap
                image = new Bitmap(dialog.FileName);
                // îòîáğàæàåì èçîáğàæåíèå â PictureBox
        ...
        private void èíâåğñèÿtoolStripMenuItem1_Click(object sender, EventArgs e)
        {
